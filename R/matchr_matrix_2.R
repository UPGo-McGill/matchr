...
is_matrix_2 <- function(x) inherits(x, "matchr_matrix_2")
...
vec_ptype_abbr.matchr_matrix_2 <- function(x, ...) "matrix"
...
obj_print_data.matchr_matrix_2 <- function(x, width = getOption("width"), ...) {
...
obj_print_footer.matchr_matrix_2 <- function(x, ...) {
...
#' @export
#' 
vec_restore.matchr_matrix_2 <- function(x, to, ..., n = NULL) {
...
as.matrix.matchr_matrix_2 <- function(x, ...) {
...
length.matchr_matrix_2 <- function(x) vctrs::vec_size(x)
