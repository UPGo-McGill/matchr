---
title: "Performance: BLAS, parallel processing, and benchmarking"
...
- Replace R's default BLAS library with one of the much faster alternatives, to enable dramatic speed up of certain linear-algebra tasks.
...
All the benchmarks which follow below were run using vecLib on macOS.
